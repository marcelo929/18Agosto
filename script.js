// Arquivo: script.js (Adaptado para o novo estilo de Chat)
...
class AssetLoader { /* ... (Nenhuma alteração nesta classe) ... */ }
class GameStage { /* ... (Nenhuma alteração nesta classe) ... */ }
class IntroStage { /* ... (Adaptado para usar addBotMessage) ... */ }
class HangmanStage { /* ... (Adaptado para usar addBotMessage) ... */ }
class FinalEnigmaStage { /* ... (Adaptado para usar addBotMessage) ... */ }
class CaixaAnonimaStage { /* ... (Adaptado para usar addBotMessage) ... */ }
class FinalTextStage { /* ... (Nenhuma alteração nesta classe) ... */ }
class Game { /* ... (Adaptado para a nova UI e eventos) ... */ }
